...
type SegmentError int32

const (
	// 未知错误
	SegmentError_SEGMENT_ERROR_UNSPECIFIED SegmentError = 0
	// 系统错误
	SegmentError_SEGMENT_ERROR_SYSTEM  SegmentError = 1
	SegmentError_SEGMENT_ERROR_NETWORK SegmentError = 2
	SegmentError_SEGMENT_ERROR_TIMEOUT SegmentError = 3
	// 文件错误
	SegmentError_SEGMENT_ERROR_FILE_NOT_FOUND  SegmentError = 10
	SegmentError_SEGMENT_ERROR_FILE_CORRUPTED  SegmentError = 11
	SegmentError_SEGMENT_ERROR_FILE_PERMISSION SegmentError = 12
	// 分片错误
	SegmentError_SEGMENT_ERROR_SEGMENT_NOT_FOUND SegmentError = 20
	SegmentError_SEGMENT_ERROR_SEGMENT_CORRUPTED SegmentError = 21
	SegmentError_SEGMENT_ERROR_SEGMENT_VERIFY    SegmentError = 22
	// 参数错误
	SegmentError_SEGMENT_ERROR_INVALID_REQUEST   SegmentError = 30
	SegmentError_SEGMENT_ERROR_INVALID_TASKID    SegmentError = 31
	SegmentError_SEGMENT_ERROR_INVALID_FILEID    SegmentError = 32
	SegmentError_SEGMENT_ERROR_INVALID_SEGMENTID SegmentError = 33
)

var SegmentError_name = map[int32]string{
	0:  "SEGMENT_ERROR_UNSPECIFIED",
	1:  "SEGMENT_ERROR_SYSTEM",
	2:  "SEGMENT_ERROR_NETWORK",
	3:  "SEGMENT_ERROR_TIMEOUT",
	10: "SEGMENT_ERROR_FILE_NOT_FOUND",
	11: "SEGMENT_ERROR_FILE_CORRUPTED",
	12: "SEGMENT_ERROR_FILE_PERMISSION",
	20: "SEGMENT_ERROR_SEGMENT_NOT_FOUND",
	21: "SEGMENT_ERROR_SEGMENT_CORRUPTED",
	22: "SEGMENT_ERROR_SEGMENT_VERIFY",
	30: "SEGMENT_ERROR_INVALID_REQUEST",
	31: "SEGMENT_ERROR_INVALID_TASKID",
	32: "SEGMENT_ERROR_INVALID_FILEID",
	33: "SEGMENT_ERROR_INVALID_SEGMENTID",
}

var SegmentError_value = map[string]int32{
	"SEGMENT_ERROR_UNSPECIFIED":       0,
	"SEGMENT_ERROR_SYSTEM":            1,
	"SEGMENT_ERROR_NETWORK":           2,
	"SEGMENT_ERROR_TIMEOUT":           3,
	"SEGMENT_ERROR_FILE_NOT_FOUND":    10,
	"SEGMENT_ERROR_FILE_CORRUPTED":    11,
	"SEGMENT_ERROR_FILE_PERMISSION":   12,
	"SEGMENT_ERROR_SEGMENT_NOT_FOUND": 20,
	"SEGMENT_ERROR_SEGMENT_CORRUPTED": 21,
	"SEGMENT_ERROR_SEGMENT_VERIFY":    22,
	"SEGMENT_ERROR_INVALID_REQUEST":   30,
	"SEGMENT_ERROR_INVALID_TASKID":    31,
	"SEGMENT_ERROR_INVALID_FILEID":    32,
	"SEGMENT_ERROR_INVALID_SEGMENTID": 33,
}

func (x SegmentError) String() string {
	return proto.EnumName(SegmentError_name, int32(x))
}

func (SegmentError) EnumDescriptor() ([]byte, []int) {
...
type DownloadSegmentRecord struct {
	...
	// 分片所在节点，及其是否可用
	SegmentNode map[string]bool `protobuf:"bytes,9,rep,name=segment_node,json=segmentNode,proto3" json:"segment_node,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	// 分片的下载状态，描述该片段的下载进度和结果
	// @gotags: badgerhold:"index"
	Status               SegmentDownloadStatus `protobuf:"varint,10,opt,name=status,proto3,enum=pb.SegmentDownloadStatus" json:"status,omitempty" badgerhold:"index"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (m *DownloadSegmentRecord) GetEncryptionKey() []byte {
	if m != nil {
...
func (m *DownloadSegmentRecord) GetStoragePath() string {
	if m != nil {
...
func (*DownloadPubSubManifestRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7ce52b48c9eea83, []int{6}
}
...
func (*DownloadPubSubManifestResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7ce52b48c9eea83, []int{7}
}
...
func (*SegmentContentRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7ce52b48c9eea83, []int{8}
}
...
type SegmentContentResponse struct {
	...
	ErrorCode            SegmentError `protobuf:"varint,15,opt,name=error_code,json=errorCode,proto3,enum=pb.SegmentError" json:"error_code,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}
...
func (*SegmentContentResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7ce52b48c9eea83, []int{9}
}
...
func (m *SegmentContentResponse) GetHasError() bool {
	if m != nil {
		return m.HasError
	}
	return false
...
func (m *SegmentContentResponse) GetErrorMessage() string {
	if m != nil {
...
func (m *SegmentContentResponse) GetErrorCode() SegmentError {
	if m != nil {
		return m.ErrorCode
	}
	return SegmentError_SEGMENT_ERROR_UNSPECIFIED
}
...
func init() {
	...
	proto.RegisterEnum("pb.SegmentError", SegmentError_name, SegmentError_value)
...
var fileDescriptor_f7ce52b48c9eea83 = []byte{
	...
	,
}
...
func (m *DownloadSegmentRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StoragePath) > 0 {
		...
		i = encodeVarintDownload(dAtA, i, uint64(len(m.StoragePath)))
		i--
		dAtA[i] = 0x3a
	}
...
func (m *SegmentContentResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ErrorCode != 0 {
		i = encodeVarintDownload(dAtA, i, uint64(m.ErrorCode))
		i--
		dAtA[i] = 0x78
	}
	if len(m.ErrorMessage) > 0 {
		...
		i = encodeVarintDownload(dAtA, i, uint64(len(m.ErrorMessage)))
		i--
		dAtA[i] = 0x72
	}
	if m.HasError {
...
func (m *SegmentContentResponse) Size() (n int) {
	...
	if m.ErrorCode != 0 {
		n += 1 + sovDownload(uint64(m.ErrorCode))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 15:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ErrorCode |= SegmentError(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
